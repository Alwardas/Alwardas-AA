...
class CoordinatorReportsScreen extends StatefulWidget {
  ...
  const CoordinatorReportsScreen({super.key, required this.userData});

  @override
  _CoordinatorReportsScreenState createState() => _CoordinatorReportsScreenState();
}
...
class _CoordinatorReportsScreenState extends State<CoordinatorReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Coordinator Reports", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: textColor)),
  ...
  Widget _buildActionButtons() {
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        Text(
          "Download and view detailed class execution reports across all branches and sections.",
