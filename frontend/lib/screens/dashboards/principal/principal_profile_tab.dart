...
class PrincipalProfileTab extends StatefulWidget {
  ...
  @override
  _PrincipalProfileTabState createState() => _PrincipalProfileTabState();
}

class _PrincipalProfileTabState extends State<PrincipalProfileTab> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PrincipalNotificationsScreen())),
          ),
          Theme(
                ...
                PopupMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Text("Logout", style: GoogleFonts.inter(color: Colors.redAccent, fontWeight: FontWeight.w600)),
                    ],
                  ),
                ),
              ],
  ...
  Widget _buildProfileCard(Color textColor, Color subTextColor, bool isDark) {
    ...
    String rawRole = widget.userData['role'] ?? 'Principal';
    final String role = rawRole.toUpperCase() == 'PRINCIPAL' ? 'Principal' : rawRole;
