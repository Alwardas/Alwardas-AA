...
class InchargeProfileScreen extends StatefulWidget {
  ...
  @override
  _InchargeProfileScreenState createState() => _InchargeProfileScreenState();
}
...
class _InchargeProfileScreenState extends State<InchargeProfileScreen> {
  ...
  Future<void> _saveChanges(Map<String, String> updates) async {
     try {
       ...
       // Logic for Incharge update: If essential fields change, might need Principal approval
       // For now, mirroring HOD and using Principal as the approver is implied by backend mods.
  ...
  Widget _buildProfileCard(Color textColor, Color subTextColor, bool isDark) {
    final contact = _phoneController.text.isNotEmpty ? _phoneController.text : 'Not Provided';
    ...
    final String role = 'INSTITUTE INCHARGE';
