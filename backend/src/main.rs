...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/api/issues/:id", axum::routing::put(student::update_issue_handler).delete(student::delete_issue_handler))
        ...
        .route("/api/faculty/issues", get(faculty::get_assigned_issues_handler))
        .route("/api/faculty/issues/:id/resolve", post(faculty::resolve_issue_handler))
